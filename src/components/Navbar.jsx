...
const Navbar = () => {
  ...
  const cartNumber = useSelector((state) => state.cart.bag);
  ...
  return (
    <div className='bg-white'>
      ...
      <header className='relative bg-white z-10'>
        <p className='flex h-10 items-center justify-center bg-gradient-to-r from-70% from-black to-white px-4 text-sm font-medium text-white sm:px-6 lg:px-8'>
            ...
            <div className='flex h-16 items-center'>
              ...
              <Link to='/'>
                <div className='ml-4 flex lg:ml-0'>
                  <span className='sr-only'>Gen Z</span>
                  <img className='h-8 w-auto' src='/logo.png' alt='logo'  />

                  <p className='my-auto font-bold text-xl text-black pl-2 font-mono'>
